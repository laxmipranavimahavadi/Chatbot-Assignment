...
# Function to chunk and process PDFs, then index in Qdrant
def process_pdfs_and_index(folder_path):
    try:
        text_splitter = RecursiveCharacterTextSplitter(
            chunk_size=500,  # Adjust this size based on your content
            chunk_overlap=50
        )
...
def search():
    try:
        ...
        results = qdrant_client.search(
            ...
            limit=1  # Return top 5 most relevant chunks
        )
